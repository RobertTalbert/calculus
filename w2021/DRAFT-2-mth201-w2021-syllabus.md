...
+ Reorganized grading system section to put assignments and final grades first (thanks Sharona)
+ Ditched the grading system requirement of Proficiency on all 6 Core targets for a C or higher
+ Eliminated alternative methods for doing Learning Targets (videos and oral exams) -- might add these in later during the semester 
+ Eliminated initial deadline rules for AEPs
+ Rewrote opening section
+ Redid table of Modules in the appendix to make it wider/shorter
+ Tried to eliminate typos

:::

# MTH 201-04: Calculus, Winter 2021 --- DRAFT 3
...
:::info
Possibly pull some of the details out and put into a separate, highly detailed document. 
:::

...
**Text:** Read through [https://activecalculus.org/single/sec-2-5-chain.html](https://activecalculus.org/single/sec-2-5-chain.html) of the *Active Calculus* textbook. You can just skim the discussion at the beginning of 2.3.1 and start paying full attention at the box titled "Product Rule". Work through the examples and all interactive exercises found at the end of the section. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE5NzEyNzU1MF19
-->
...
**Video:** First, review the videos on composite functions and fundamental algebraic structure that were created and posted for the Functions Bootcamp assignment: 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NjIwMzg1OTJdfQ==
-->
...
**Text:** In the _Active Calculus_ text, read in [Section 3.1](https://activecalculus.org/single/sec-3-1-tests.html) starting with Example 3.1.10 and continuing through the end. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE0Mjg1NTczMF19
-->
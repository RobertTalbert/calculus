...
+ **Drop-in hours**: These arwill be held on Zoom; the link and password are on Blackboard in the *Syllabus and Calendar* aCampuswire via the "Live Sesssion" featurea. You do *not* need an appointment for permission todrop-in hours. Specific time for drop -in. The hours are **2:00-2:50 pm Tuesdays and 12:00-1:50pm Fridays**will be determined in week 1. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjI0NDMwNjc2LC01NjA5NzY3MCwxOTYxMT

...
So the math that we learned in high school, where everything comes from a nice-looking formula, has limited usefulness. In real life, we are working with either 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg0NTQ2MzgwMl19
-->
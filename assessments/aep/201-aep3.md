...
Functions can be simple, like this one: 
![enter image description here](https://i.ibb.co/wdrYPP7/desmos-graph-18.png)

Or they can be ridiculously complex, [like this one](https://en.wikipedia.org/wiki/Gamma_function): 
![enter image description here](https://i.ibb.co/SN3nCK1/325px-Gamma-plot-svg.png)

Most functions that tell us important things about the world are either
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzY2NDYzMTU3XX0=
-->
...
2. According to the data about Google stock prices whose graph you saw above, the value of Google stock over the course of the morning of Thursday, September 10, 20 was: 
...
3. Find a local linearization of Google's stock prices at noon, and use it to predict the stock price at 1:00pm on September 10, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjg4MzM2MDMxXX0=
-->
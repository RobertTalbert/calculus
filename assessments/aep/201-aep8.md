...
Finally: **You are allowed to use computer tools to find derivatives and do algebraic simplification on this AEP.** For example you may use [Wolfram|Alpha](http://wolframalpha.com) to find derivatives and solve equations. **If you do, you must include a link to your calculations.** You do this just by copying a
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk0NjI1NTY3MSwtMTEwMzUyNDM5MiwtMT

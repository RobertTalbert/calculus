...
- **Each solution must use Calculus techniques to find the optimum value begin asked for.** You may not simply estimate the value from a gr
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjc1MjcwMjQ4LC0xMTAzNTI0MzkyLC0xNT
UxMDU1MDA3LDE0NzgwMTM3MzBdfQ==
-->
...
Second, on Thursday November 12, I will be posting a written solution for one of the problems from the Module 9B Followup Activity that, if turned in as an AEP, would earn an "E" grade under the grading standards at the end of this document. This will be posted in the Module 9 folder. Study it and use it as a model for what, and how, to communicate are you are doing your solution. **Pay close attention to the grading standards at the end** as they give specific requirements for how you need to write your solutions. 
...
2. Two vertical poles, one 8 feet high and the other 10 feet high, stand 50 feet apart on a flat surface. We want to attach a support wire to each poles by running wire from the ground to the top of each pole. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIwMDYyMjcwNiwxOTg0MjAwODA2LC0xMT
AzNTI0MzkyLC0xNTUxMDU1MDA3LDE0NzgwMTM3MzBdfQ==
-->
...
2. A poster is being designed so that the paper on which it's printed has an area of 200 square inches. The actual printed part of the poster has to fit inside an area on this paper 1-inch margins on the top and bottom and 2-inch margins on the sides, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMTgxMzUyMjgsLTE1NTEwNTUwMDcsMT
Q3ODAxMzczMF19
-->
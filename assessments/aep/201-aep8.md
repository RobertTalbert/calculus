...
- **Each solution must produce a formula in one variable for the target quantity and show all the work that was used to arrive at that formula.** 
- **Each solution 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2OTE5MTE3OTksLTExMDM1MjQzOTIsLT

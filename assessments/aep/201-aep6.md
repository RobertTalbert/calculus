...
2. Using the derivative rules of Chapter 2, find the first derivative of your logistic function. You'll need to show all the steps on this. To make this neat and professional: First do all the calculus on separate pages 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjMyNjYwNDAsMTgwNzI3NzgzMiwtND
g1NTI3MzcwXX0=
-->
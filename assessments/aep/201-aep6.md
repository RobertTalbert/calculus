...
- $L$ is the upper limit that the data approach as $x$ gets very large
- $k$ is a growth rate 
- $a$ is a shift value 
...
Here's a Desmos graph that allows you to play with sliders to see the effects of changing the parameters in a logistic function: 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTU5MzIyMDcxXX0=
-->
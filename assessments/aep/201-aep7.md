...
4. The data from the CDC chart has a particular shape that is well-suited for *logarithmic functions*. (Here's a graph of the basic $y = \ln(x)$ function: 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0ODYyMTQsMTgzODM4MTMxMCwxNzg4MD
I0MzYwLC00ODM1MzM3OThdfQ==
-->
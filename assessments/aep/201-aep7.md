...
6. The data in the CDC charts ends at 36 months. But we can use the derivative to make predictions for data not on the charts. Using the results of your work in the previous step, predict the value of the physical attribute you chose (length or weight) for a child who is 4 years o
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NzA0MjY1MzIsMTgzODM4MTMxMCwxNz

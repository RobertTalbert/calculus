...
- **Change the permissions on your Google Sheet** so that *Anyone with the link* has access, and the access is *Editor* not "Viewer". 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDg3Mzg5MjEsMTgzODM4MTMxMCwxNz
